...
const Page: React.FC = () => {
  ...
  useEffect(() => {
    const deadline = new Date("2025-05-16T23:59:59").getTime();
  ...
  return (
    <div className="min-h-screen bg-white text-blue-800">
      ...
      <header className="py-24 px-4 text-center max-w-5xl mx-auto">
        ...
        <div className="mt-12">
          <h3 className="text-xl mb-3 text-blue-700">
      ...
      <main className="max-w-5xl mx-auto px-4 ">
        <section className="mb-20">
          ...
          <div className="bg-blue-50 p-8 rounded-xl border border-blue-200 shadow-md">
            ...
            <p className="text-2xl font-bold mb-6 text-center text-blue-800">
              We're changing that.
            </p>
            <p className="text-xl mb-6 text-blue-700">
            ...
            <p className="text-xl font-light text-center italic mt-8 text-blue-700">
        ...
        <section className="mb-20">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              <div
                key={index}
                className="bg-blue-50 p-6 rounded-xl border border-blue-200 hover:border-blue-400 transition-all shadow-md"
              >
      ...
      <footer className="bg-blue-100 py-12 mt-12">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-blue-500 mt-8 text-xs">
